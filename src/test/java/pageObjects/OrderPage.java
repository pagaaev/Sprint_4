...
public class OrderPage {
    ...
    public void waitForLoadForm() {
        waitForElementLoad(this.orderForm);
    }
    ...
    public void setMetro(String metro) {
        ...
        waitForElementLoad(this.metroList);
        chooseElementFromDropdown(this.metroListItems, metro);
    }
    ...
    public void setDate(String date) {
        ...
        waitForElementLoad(this.dateSelected);
        clickDateSelected();
    }
    ...
    public void setTerm(String termToChoose) {
        clickTermDropdown();
        chooseElementFromDropdown(this.termDropdownOption, termToChoose);
    }
    ...
    public void setColor(String colorToChoose) {
        chooseElementFromDropdown(this.colorLabels, colorToChoose);
    }
    ...
    public void makeOrder() {
        clickOrderButton();
        waitForElementLoad(this.acceptOrderButton);
     ...
     * @param dropdownElements элемент страницы с данными из выпадающего списка
